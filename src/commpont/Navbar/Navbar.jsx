...
export default function Navbar() {
  ...
  return (
    <>
       <Disclosure as="nav" className="bg-[#4FA74F] fixed top-0 right-0 left-0 z-40">
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-shrink-0 items-center">
            ...
            <div className="hidden sm:ml-6 sm:block">
             ...
             <li className='font-bold'><NavLink to="">Prodects</NavLink></li>
             ...
             <li className='font-bold'><NavLink to="whish"> Favorite</NavLink></li>
            </ul>}
          ...
          <div className="flex space-x-3 hidden md:block">
            ...
            <li className='font-bold relative'><Link to="cart"><i className="fa-solid fa-cart-shopping fa-xl text-white"></i><span className='absolute left-3 -top-[9px] bg-[#4FA74F] rounded-md w-auto h-auto px-1 text-center'>{items?items.numOfCartItems:'0'}</span></Link></li>
